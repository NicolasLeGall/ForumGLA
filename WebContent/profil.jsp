...
<html>
    ...
    <body>
        ...
        <div class="content">
        <p> Login: ${utilisateur.login}, Profil utilisateurs: ${utilisateur.profil}, nom photo${utilisateur.avatar}</p>
         <a href="http://localhost:8080/ForumGLA/upload">upload image de profil</a><br>
			<img src="fichiers/${utilisateur.avatar}" width="100" height="100" alt="Votre photo de profil">
